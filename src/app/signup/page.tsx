  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#F7F5F3] dark:bg-black items-center justify-center p-12">
        ...
        {/* Decorative lines like landing page */}
        ...
        <div className="relative z-10 w-full max-w-md text-center space-y-8">
          ...
          <div className="space-y-3">
            <h2 className="text-4xl font-normal text-[#37322F] dark:text-white tracking-tight font-[var(--font-instrument-serif)]" style={{ fontFamily: 'var(--font-instrument-serif)' }}>
              Get Started with Us
            </h2>
            ...
            {steps.map((step) => (
              <div
                ...
                className={`flex items-center gap-4 rounded-xl px-4 py-3.5 transition-colors ${
                  step.num === 1
                    ? "bg-white/70 dark:bg-white/[0.08] border border-[rgba(55,50,47,0.08)] dark:border-white/[0.08] shadow-sm"
                    : "bg-white/30 dark:bg-white/[0.03] border border-[rgba(55,50,47,0.04)] dark:border-white/[0.04]"
                }`}
              >
                <div
                  className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-sm font-medium ${
                    step.num === 1
                      ...
                      : "bg-[rgba(55,50,47,0.06)] dark:bg-white/[0.06] text-[rgba(55,50,47,0.3)] dark:text-white/30"
                  }`}
                >
                  {step.num}
                </div>
                <span
                  className={`text-sm font-medium ${
                    step.num === 1
                      ...
                      : "text-[rgba(55,50,47,0.3)] dark:text-white/30"
                  }`}
                >
                  {step.label}
                </span>
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-[#37322F] dark:text-zinc-300 text-sm">
                Full Name
              </Label>
              <Input
                id="name"
